...
import type { SortField as _SortField, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: Array<OrderItem>, arg1: string, arg2: string): Promise<AppOrder> {
        if (this.processError) {
            try {
    ...
    async getMyOrders(): Promise<Array<AppOrder>> {
        if (this.processError) {
            try {
    ...
    async getProducts(arg0: string | null, arg1: bigint | null, arg2: bigint | null, arg3: SortField | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProducts(to_candid_opt_n13(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n15(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_SortField_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortField): _SortField {
...
function to_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortField | null): [] | [_SortField] {
    return value === null ? candid_none() : candid_some(to_candid_SortField_n16(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortField): {
    priceAscending: null;
} | {
    priceDescending: null;
} {
    return value == SortField.priceAscending ? {
        priceAscending: null
    } : value == SortField.priceDescending ? {
        priceDescending: null
    } : value;
}
